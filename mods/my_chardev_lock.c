/*  my_chardev_lock.c - Simple character device module
 *  
 *  Demonstrates module creation of character device for user
 *  interaction.  Also utilizes/demostrates kmalloc and write.  Fixes
 *  race condition on file open in my_chardev_mem.c
 *
...
static int device_open(struct inode *inode, struct file *file)
{
  ...
  if (Device_Open){		/* Device_Open is my flag for the
				   ...
				   in my_chardev_mem.h)  */
    up(&sem);			/* ALWAYS release your semaphores on
				   error conditions! */
